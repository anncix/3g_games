...
async def seed():
    ...
    async with SessionLocal() as db:
        ...
        # ---------- v0.2.3：幻想西游（spec 参数补全 + 全网检索扩展）----------
        # v0.2.2 基线：10场景(9区域) + 45技能(5门派×9) + 108装备(6品质×6部位×3档) + 8龙宫叉系列 + 19副本 + 13宠物 + 14药品/经验道具
        # v0.2.3 新增：3副本(大雁塔/盘丝洞/降妖除魔) + 14种药品完整参数表 + 19种高级升级材料 + 12条长安城坐标
        await seed_xyou(db)
